...
function setup() {
	...
	bob1 = Bodies.circle(380,300,30)
	World.add(world,bob1);

	bob2 = Bodies.circle(350,300,30)
	World.add(world,bob2);

	bob3 = Bodies.circle(320,300,30)
	World.add(world,bob3);

	bob4 = Bodies.circle(290,300,30)
	World.add(world,bob4);

	bob5 = Bodies.circle(260,300,30)
...
if(keyDown("right")){
Matter.Body.applyForce( Matter.Body.applyForce(bob5,{x:0,y:0},{x:0.05,y:0}));
